...
{
    public class NonRxnTestFixture
    {
    ...
    public class NonRxnTests : ReactionFileParserTest, IClassFixture<NonRxnTestFixture>
    {
        ...
        public NonRxnTests(ReactionFileParserTestHarness harness, ITestOutputHelper output, NonRxnTestFixture initFixture) : base(harness, output)
        {
            Id = initFixture.Id;
        ...
        [Fact]
        public void RxnParsing_NonRxnFile_ReceivedEventsShouldContainValidData()
        {
